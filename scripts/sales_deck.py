...
PHASES = [
    ...
    ("05", "品質採点", "機械採点18項目を全て通したうえで、執筆とは別の工程が3観点で採点。"
...
GATES = [
    ...
    ("別工程の採点", "3観点×100点", "一次性／抽出性／決定支援。執筆とは別の工程が本文だけを読んで採点。"
                            "1観点でも80点未満なら、総合が高くても不合格"),
...
FAQS = [
    ("記事の品質は大丈夫ですか。AIが書いた記事だと分かりませんか？",
     ...
     "さらに3観点（一次性・抽出性・決定支援）の採点で、各80点以上かつ総合90点以上に届かない記事は公開されません。"
     "実際の記事は貴社サイトでご確認いただけますので、まずは既存メディアの記事をご覧ください。"),
    ("効果が出るまでどれくらいかかりますか？",
     "検索での順位は、記事公開から評価が安定するまで6〜8ヶ月かかるのが一般的です。"
     "ただし記事は資産として積み上がるため、8ヶ月目以降は同じ費用でも成果が伸び続けます。"
...
<div class="warn"><b>成果が見え始める時期の目安:</b> 検索での順位は、公開から6〜8ヶ月で安定してきます。
