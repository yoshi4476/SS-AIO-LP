...
(function () {
  ...
  function result() {
    ...
    body.innerHTML =
      ...
      '<p><strong>この診断は、ご回答をもとにした簡易版です。</strong></p>' +
      '<p>実際の御社サイトの情報をお預かりし、評価軸ごとに詳細に測るシステムを別途ご用意しています。本格的に現状を分析されたい際は、お気軽にご連絡くださいませ。</p>' +
      '<p class="dn-free">こちらの簡易診断は、無料でご利用いただけます。</p></div></div>';
