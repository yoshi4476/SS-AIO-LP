...
<a href="https://www.brightlocal.com/research/local-consumer-review-survey-2025/" target="_blank" rel="noopener">BrightLocalのLocal Consumer Review Survey 2025</a>（米国の消費者1,026人調査）によると、<strong>消費者の71%が地域の店を探す際に口コミを日常的に読み</strong>、口コミの確認先としては<strong>83%がGoogleを利用</strong>しています。さらに48%は、AIが生成した口コミの要約も読むと回答しており、口コミはAI検索の素材にもなり始めています。
