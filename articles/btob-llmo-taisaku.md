---
title: BtoB AI検索対策（LLMO）とは？発注候補に残る条件
description: BtoB AI検索対策（LLMO）とは、生成AI検索の回答内で発注候補として挙げられるための最適化です。検索順位は取れているのにAIに出てこない企業向けに、候補に残る企業が満たす条件と埋めるべき差分を実データで解説します。
