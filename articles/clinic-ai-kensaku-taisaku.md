...
<span class="txt-blue">共通しているのは、患者が「自分が対象かどうか」を先に知りたがることです。</span>診療内容の説明より、**受診の判断に必要な情報**を先に置くほうが引用されます。

<span class="txt-red">症状から診断を断定する書き方は避けてください。</span>医療広告ガイドラインに触れる可能性があり、**AIも断定的な医療情報の引用には慎重**です。「◯◯の場合は受診をご検討ください」という書き方に留めます。
